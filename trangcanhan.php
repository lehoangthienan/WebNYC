	...
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" id="center">
		<div class="box_center">
			<div class="box_center_top">
				<div class="box_center_top_l"><p>Trang cá nhân</p></div>
				...
				<div class="row">
					<?php
						...
						else
						{
							...
							$query_pg="SELECT COUNT(id) FROM tblsanpham WHERE ten LIKE '%{$tukhoa}%'  AND status='0' AND idnguoidang={$a}";
						...
						$query="SELECT * FROM tblsanpham WHERE ten LIKE '%{$tukhoa}%' AND idnguoidang={$a} AND status='0' ORDER BY thoigian DESC LIMIT {$start},{$limit}";
