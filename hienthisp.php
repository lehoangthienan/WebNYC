			...
			<div class="box_center">
				...
				<div class="box_center_main">
					...
					if(isset($_POST["dang_bai"])) {
						...
						$query="UPDATE `tblsanpham` SET `status` = '0' WHERE `tblsanpham`.`id` = {$id}; ";
						$results=mysqli_query($dbc,$query);
						kt_query($results,$query);
					...
					<input class="sanpham_box_order" type="submit" name="dang_bai" class="btn btn-primary" value="Hiện bài đăng">
					</form>
