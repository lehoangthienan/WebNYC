...
<div class="box">
     <div class="box_top">
     	<p>Chi Tiết Người Đăng</p>
     </div>
     <div class="box_main">
     	<div class="detial-name">
     		<i class="fas fa-user" aria-hidden="true"></i>
			<span class="name-label">Người chia sẽ:</span>
			<span class="name">Nguyễn Tiến Đạt</span></p>
		</div>
		<div class="hotline_button">
               <center>
			<button class="button numberphone" title="Hotline" aria-label="Hotline"><span><i class="fa fa-shopping-cart" aria-hidden="true"></i> </span> 0973043044 </button>
               </center>
		</div>
          <div class="detail-adress">
               <span> <i class="fas fa-address-book" aria-hidden="true"></i>
               <snap class="adress-label">Địa chỉ:</snap>
               <snap class="adress"> Quận Thủ Đức , TPHCM </snap>
          </div>
